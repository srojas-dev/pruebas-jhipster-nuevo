  ...
  return (
    <div>
      ...
      <Table responsive striped>
        <thead>
          <tr>
            <th className="hand" onClick={sort('id')}>ID <FontAwesomeIcon icon={getSortIconByFieldName('id')} /></th>
            <th className="hand" onClick={sort('login')}>Login <FontAwesomeIcon icon={getSortIconByFieldName('login')} /></th>
            <th className="hand" onClick={sort('email')}>Email <FontAwesomeIcon icon={getSortIconByFieldName('email')} /></th>
            <th />
            <th>Perfiles</th>
            <th className="hand" onClick={sort('createdDate')}>Fecha de creación <FontAwesomeIcon icon={getSortIconByFieldName('createdDate')} /></th>
