...
<<<<<<< Updated upstream
To build the final jar and optimize the asdasd application for production, run:
=======
To build the final jar and optimize the asdasdads application for production, run:
>>>>>>> Stashed changes
